...
sumstats_allstudy<- sumstats_allstudy  %>% mutate(bc=ifelse(grepl("_bc",site),1,0))
...
ggplot(looklong %>% filter(site=="bsi"), aes(date, org, color=measure, fill=measure))+geom_tile()+
...
beast123(y=datcorr,
         metadata=list(freq=12, whichDimIsTime=2),
         prior,
         mcmc=tslong_p2extra
