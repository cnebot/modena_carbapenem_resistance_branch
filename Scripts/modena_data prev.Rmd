...
# optional:  package.list<-c('tidyverse','earth','tseries','tsutils','forecast','fpp3','plotmo','mgcv','smooth','lmtest','stats','grid','lattice','viridis','hrbrthemes','sysfonts','lubridate','car','strucchange','ganttrify','patchwork','missForest','mgcViz','lmtest','feasts','fpp3','AID','devtools') %>% install.packages(destdir = "C://R",dependencies = TRUE)
